...
const Explore = () => {
  // Using reliable image URLs for the 3x3 grid
  const explorePosts = [
  ...
  return (
    <div className="flex justify-center w-full min-h-screen bg-black">
      {/* Container max-width matching Instagram */}
      <div className="w-full max-w-[935px] pt-6 pb-20 px-4 md:px-0">
        
        {/* Simple 3-column grid of squares with gap-1 matching the user's screenshot exactly */}
